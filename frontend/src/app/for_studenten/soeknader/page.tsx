...
const soeknaderPage = () => {
  const unnagjortCards: nyStudentCardProps[] = [
    {
      ...
      buttons: [{ text: "Søk om støtte her", href: "https://docs.google.com/forms/d/e/1FAIpQLSdlweUahxa6eTMwyYTz6iLzgc7NwFx_NDKIWJ6PKbS4v7jPDQ/viewform" }]
    },
...

    {
      ...
      frist: "",
      buttons: [{ text: "Se eldre søknader", href: "https://drive.google.com/drive/folders/1nM-PpRLzSYRzXTxGqjNdU8iynfK6UO3p" }],
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center text-white">
      ...
      <div className="bg-green-dark text-white px-12 py-10 flex flex-col items-center rounded-b-lg">
        ...
        <div className="flex justify-center items-center py-4 pt-1">
          <div className="w-full flex flex-col items-center lg:items-stretch justify-center lg:flex-row gap-y-4 lg:gap-y-0 lg:gap-x-4 lg:py-8">
            <div className="w-[90%] max-w-lg bg-green-dark-backdrop px-12 py-5 rounded-md">
            ...
            <div className="w-[90%] max-w-lg bg-green-dark-backdrop lg:w-fit flex flex-col justify-between gap-y-4 px-12 py-5 rounded-md">
        ...
        <div className="bg-green-dark-backdrop p-6 w-fit rounded-md">
          ...
          <div className="flex flex-col gap-8 max-w-lg">
            ...
            <div>
              ...
              <p className="pb-4">Konkret og utfyllende om hva det søkes midler til. For eksempel:</p>
            ...
            <div>
              <p className="font-bold pb-1">3. Hvordan prosjektet vil gangne linjeforeningens medlemmer</p>
              <p className="pb-4">
            ...
            <div>
              <p className="font-bold pb-1">4. Er det sendt i søknad til Sit eller andre relevanteorganisasjoner?</p>
              <p className="">
