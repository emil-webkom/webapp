...
const ForStudentenPage = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center w-full p-12 gap-y-6">
      <div className="w-full ">
        <img src="/image/Komiteer/HS/HSfelles.jpg"
          alt="Hovedstyret fellesbilde"
          className="rounded-md object-cover w-full h-[19rem]"/>
      </div>
      <div className="flex text-white justify-center items-center text-2xl font-bold gap-x-3">
        <p>Arrangementer</p>
        <svg
          width="25"
          height="25"
        ...
        <div className="text-white flex flex-col max-w-[512px] space-y-3 text-sm lg:text-l">
          <p>Linjeforeningen arrangerer en rekke ulike arrangementer og disse kan være for kun komiteene eller hele linjeforeningen. Ofte arrangerer komiteene arrangementer for medlemmene sine, men de kan også arrangere for hele linjeforeningen. </p>
          <p>Påmelding til arrangementer skjer både gjennom nettsiden og gjennom emils
            <span className="text-[#9DDBAD]"> Facebookgruppe</span>.
             Ved spørsmål angående arrangementer kan man henvende seg til arrangør eller hovedstyret.</p>
          <p>Typen arrangementer som holdes kan være alt fra sosiale arrangementer, faglige arrangementer, ekskursjoner og bedriftspresentasjoner. Sistnevnte her er det
            <span className="text-[#9DDBAD]"> Emil-Link </span>
           som er ansvarlig for. Uansett hvilket arrangement man skal delta på har vi retningslinjer på Emil som må følges uavhengig av hva som gjennomføres.</p>
        </div>
