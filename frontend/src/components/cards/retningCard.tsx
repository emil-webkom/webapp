...
const RetningCard: FC<CardProps> = ({ name, subname, text, link }) => {
    return (
        ...
        <div className="text-xl font-semibold px-10 h-[5.4rem] overflow-hidden">{name}</div>
            <div className="text-m font-light px-10 ">{subname}</div>
            <div className="text-l font-light px-10 py-5 h-[10rem] overflow-hidden">{text}</div>
