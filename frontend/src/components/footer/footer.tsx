...
const Footer: FC = () => {
  return (
    <footer>
      <div className="w-screen flex justify-between bg-[#001D21] text-white px-10 font-bold py-5">
      ...
      <div className="flex w-screen items-center justify-center bg-[#001D21] py-2">
        <img
