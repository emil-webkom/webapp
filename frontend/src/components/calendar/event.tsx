  ...
  return (
      ...
      >
        <div className="flex flex-col text-left p-2">
          <div className="font-light text-sm lg:text-base lg:font-normal">{title}</div>
        ...
        <div className="flex flex-col w-1/2 justify-end text-right p-2">
          <div className="font-light text-sm lg:text-base lg:font-normal">{trinn}. trinn</div>
          <div className="flex flex-row justify-end gap-x-1">
            <div className="flex font-light text-sm lg:text-base lg:font-normalmt-0.5">{location}</div>
            <div className="flex items-center justify-center">
              <MapPin size={14} />
            </div>
          </div>
