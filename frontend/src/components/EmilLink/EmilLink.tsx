...
const EmilLink = () => {
  return (
    <div className="bg-[#] rounded-md flex flex-col items-center space-y-4 justify-center text-center py-18 text-green-darkest">
      <h1 className="font-extrabold text-3xl py-6 ">For bedriften</h1>
      <h2 className="font-semibold  text-xl">
        Bedriftspresentasjon på Gløshaugen
      </h2>
      <p className="font-thin text-left px-6">
        Her foregår en presentasjon på ettermiddagen/kvelden etterfulgt av
        middag enten på Gløshaugen eller i byen.
      </p>

      <div className="w-[95%] lg:w-[45%] flex flex-col justify-center items-center px-4 lg: py-7">
        <div className="flex flex-col lg:flex-row lg:justify-between gap-11 lg:gap-16 w-full text-left">
          <div className="bg-green-mid text-white rounded-md p-4  lg:w-1/2 ">
            ...
            <p className="font-thin text-sm ">
              Dette kaller vi for lunsjbedriftspresentasjon, og foregår på
              dagen. Da serveres det lunsj i stedet for middag. Dette foregår
              oftest på Gløshaugen da studentene har andre forelesninger utover
              dagen.
            </p>
          </div>
          ...
          <div className="bg-green-mid text-white rounded-md p-4 lg:w-1/2 ">
            ...
            <p className="font-thin text-sm ">
              {" "}
              Vi kan også tilby en mindre og mer intim bedriftspresentasjon hvor
              det kun er få studenter invitert. Idéen er da å invitere til en
              bedre middag etterpå, hvor bedriften kan komme i nærmere kontakt
              med aktuelle arbeidstagere for fremtiden
            </p>
          </div>
        </div>
      </div>
      ...
      <p className="font-extralight text-left text-sm lg:text-base leading-relaxed max-w-4xl px-6">
      ...
      <p className="font-extralight text-sm lg:text-base leading-relaxed max-w-4xl">
        <i>
          Dersom din bedrift ønsker å komme i kontakt med energi og
          miljøstudentene, så ta kontakt med{" "}
          <span className="text-[#3A766C] font-semibold">
